...
import { CommercialPaperRecord } from '../../types';
...
export const CommercialPapersSheet: React.FC<SheetProps> = ({ onOpenAddModal }) => {
  ...
  const saveEditTax = (r: CommercialPaperRecord) => {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        ...
        <div className="bg-[#ffffff] border border-[#e3e2e1] p-5 rounded">
          ...
          <div className="text-xs text-[#747878] mt-1">Principal + Net Interest</div>
        </div>
      </div>
        ...
        <div className="p-4 border-b border-[#e3e2e1] flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-[#747878]">Fixed-tenor corporate commercial paper issues with manually editable tax rates</p>
            </div>
          </div>
          <button
