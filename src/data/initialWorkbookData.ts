...
export const initialLockedSavingsRecords: LockedSavingsRecord[] = [
  {
    ...
    durationDays: 60,
    grossInterestNaira: 60821.92,
    taxApplicable: true,
    taxRatePercent: 9.9668, // Exactly matches ₦6,062 workbook withholding tax
    taxAmountNaira: 6062.00,
  ...
  },
  {
    ...
    durationDays: 60,
    grossInterestNaira: 39452.05,
    taxApplicable: true,
    taxRatePercent: 9.9995, // Exactly matches ₦3,945 workbook withholding tax (~10%)
    taxAmountNaira: 3945.00,
